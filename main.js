  ...
  tr: {
    ...
    presets: {
      strategy: {
        ...
        p2Legend: "Toplam Maliyet / Risk",
        categories: [
          { id: "c1", title: "Mevcut Yapıyı Korumak (Status Quo)", totalLabel: "Temel Güvence Getirisi", isPositive: true, items: [
          ...
          { id: "c2", title: "Büyük Atılım ve Büyüme Hamlesi", totalLabel: "Beklenen Stratejik Getiri", isPositive: true, items: [
            { label: "Pazarda asimetrik ölçeklenme potansiyeli", score: 5.5, enabled: true }
          ]},
          { id: "c3", title: "Dönüşüm Sürtünmesi ve Geçiş Maliyeti", totalLabel: "Toplam Sürtünme Maliyeti", isPositive: false, items: [
      ...
      repair: {
        ...
        categories: [
          { id: "c1", title: "Alınan Hizmet & Servis Gelirleri", totalLabel: "Toplam Servis Cirosu", isPositive: true, items: [
          ...
          { id: "c2", title: "Parça, Sarf Malzeme ve Operasyonel Giderler", totalLabel: "Toplam Onarım Maliyeti", isPositive: false, items: [
      ...
      farm: {
        ...
        categories: [
          { id: "c1", title: "Kazanılan Drop, Loot & Etkinlik Gelirleri", totalLabel: "Toplam Brüt Slot Getirisi", isPositive: true, items: [
          ...
          { id: "c2", title: "Sarfiyat, Otomasyon & Sürtünme Giderleri", totalLabel: "Toplam Farm Maliyeti", isPositive: false, items: [
      ...
      vehicle: {
        ...
        categories: [
          { id: "c1", title: "Seyahatin Sağladığı Doğrudan Değer", totalLabel: "Toplam Ulaşım Faydası", isPositive: true, items: [
            { label: "Alternatif taksi / bilet tasarrufu", score: 850, enabled: true }
          ]},
          { id: "c2", title: "Yakıt ve Yol Giderleri", totalLabel: "Reel Seyahat Gideri", isPositive: false, items: [
      ...
      hardware: {
        ...
        categories: [
          { id: "c1", title: "Satın Almanın Sağlayacağı Doğrudan Faydalar", totalLabel: "Temel Fayda Skoru", isPositive: true, items: [
          ...
          { id: "c2", title: "Maliyet, Taksit Yükü & Fırsat Kayıpları", totalLabel: "Maliyet ve Risk Skoru", isPositive: false, items: [
  ...
  en: {
    ...
    presets: {
      strategy: {
        ...
        p2Legend: "Total Friction / Risk",
        categories: [
          { id: "c1", title: "Maintaining Status Quo", totalLabel: "Core Guaranteed Return", isPositive: true, items: [
          ...
          { id: "c2", title: "Aggressive Expansion", totalLabel: "Expected Strategic Upside", isPositive: true, items: [
            { label: "Asymmetric market scalability", score: 5.5, enabled: true }
          ]},
          { id: "c3", title: "Transition Friction", totalLabel: "Total Friction Cost", isPositive: false, items: [
      ...
      repair: {
        ...
        categories: [
          { id: "c1", title: "Service Revenues", totalLabel: "Total Revenue", isPositive: true, items: [
            { label: "Labor and diagnostic fee", score: 150, enabled: true },
            { label: "Hardware markup margin", score: 200, enabled: true }
          ]},
          { id: "c2", title: "Parts & Operational Costs", totalLabel: "Total Cost", isPositive: false, items: [
      ...
      farm: {
        ...
        categories: [
          { id: "c1", title: "Loot & Event Revenues", totalLabel: "Gross Slot Revenue", isPositive: true, items: [
            { label: "Trash loot cash yield", score: 14.50, enabled: true },
            { label: "High-value drops and upgrades", score: 28.00, enabled: true }
          ]},
          { id: "c2", title: "Consumables & Friction Costs", totalLabel: "Total Farm Cost", isPositive: false, items: [
      ...
      vehicle: {
        ...
        categories: [
          { id: "c1", title: "Transport Value", totalLabel: "Total Utility", isPositive: true, items: [
            { label: "Taxi / alternative ticket savings", score: 45, enabled: true }
          ]},
          { id: "c2", title: "Fuel & Road Costs", totalLabel: "Real Trip Cost", isPositive: false, items: [
      ...
      hardware: {
        ...
        categories: [
          { id: "c1", title: "Direct Benefits", totalLabel: "Base Utility Score", isPositive: true, items: [
            { label: "Net time saved in rendering/workflow", score: 3.5, enabled: true }
          ]},
          { id: "c2", title: "Costs & Opportunity Risks", totalLabel: "Cost & Risk Score", isPositive: false, items: [
...
function renderCardsDOM(container, state, isInteractive = false, onStateChange = null) {
  ...
  // Aktif (onaylı) maddelerin artı ve eksi toplamlarını dinamik hesapla
  ...
  state.categories.forEach(cat => {
    cat.items.filter(i => i.enabled).forEach(item => {
      ...
      if (val >= 0) {
        dynamicPositiveTotal += val;
      } else {
        dynamicNegativeTotal += val;
      }
    });
  });
  ...
  state.categories.forEach((cat, idx) => {
    ...
    labels.createSpan({ text: state.unitSymbol ? `${t.unitLabel} (${state.unitSymbol})` : t.unitLabel });
  ...
  // 2. Payoff Matrisi (Tam Dinamik, Kırmızı-Yeşil ve Genişletilmiş)
  if (state.showMatrix) {
    ...
    // Elle Değiştirilebilir Açıklama Alanı
    if (isInteractive) {
    ...
    state.strategies.forEach((strat, rIdx) => {
      ...
      // Genişletilmiş Sol Strateji Alanı (Textarea)
      ...
      state.opponents.forEach((opp, cIdx) => {
        ...
        // Hücre değerleri: Kayıtlı özel değer yoksa dinamik hesaplanan değerleri bas
    ...
    // Düzenlenebilir Alt Lejant (Yeşil & Kırmızı)
...
class GameTheoryView extends ItemView {
  constructor(leaf) {
    super(leaf);
    this.state = this.loadPreset('strategy', 'tr');
  }
  ...
  render() {
    ...
    addCatBtn.onclick = () => {
      this.state.categories.push({ id: "c_" + Date.now(), title: "...", totalLabel: t.totalDefault, isPositive: true, items: [] });
      this.render();
    };
  ...
  async saveDoc() {
    ...
    // Dinamik artı ve eksi toplamlar
    let dynPos = 0;
    let dynNeg = 0;
